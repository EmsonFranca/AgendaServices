...
from agenda_service.api.views import ServicoViewSet, ExecucaoServicoViewSet, FeedbackViewSet

router = SimpleRouter()

router.register("users", UserProfileExampleViewSet, basename="users")

router.register('servicos', ServicoViewSet, basename="service")
router.register('execucoes', ExecucaoServicoViewSet, basename="execution")
